...
class MainActivity : AppCompatActivity() {
    ...
    private fun setUpDatePicker() {
        btnDatepicker.setOnClickListener{
            ...
            //if someone cancels the date picker
            datePicker.addOnNegativeButtonClickListener {
                Log.d("DATEPICKER", datePicker.headerText)
            }
            //if some neither clicks ok nor cancel i.e. -->Back button
    ...
    private fun setUpFireStore() {
        ...
        val collectionsReferance = firestore.collection("quizzes")
        collectionsReferance.addSnapshotListener { value, error ->
            if(value == null || error != null){
                Toast.makeText(this, "Error in fatching data", Toast.LENGTH_LONG).show()
